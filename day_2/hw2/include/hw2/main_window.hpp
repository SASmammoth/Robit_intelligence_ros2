...
public:
  ...
  std::shared_ptr<My_trutle_remote> my_remote;
...
private slots:
  ...
  // 레코드 관련 버튼
  void on_recodeStartButton_clicked();
  void on_playRecodeButton_clicked();
  void on_recodeStopButton_clicked();
...
private:
  ...
  QTimer* status_timer_; // 상태 출력 갱신용 타이머
  void update_status();  // textBrowser_2 갱신 함수
};
